...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      loc === "en"
        ? "General terms of sale and use of the Keywi service."
        : "Conditions générales de vente et d'utilisation du service Keywi.",
...
export default async function PageCgv({
  ...
  const fr = {
    ...
    sections: [
      { h: "1. Objet", p: "Les présentes conditions régissent l'utilisation du service Keywi de dépôt et de remise de clés via un réseau de commerces partenaires." },
      { h: "2. Service", p: "Keywi met en relation des déposants et des points relais. Le déposant reste responsable des clés confiées et des accès qu'il partage via les codes de retrait." },
      ...
      { h: "4. Responsabilité", p: "Keywi s'engage à assurer la traçabilité de chaque mouvement. La remise des clés est conditionnée à la présentation d'un code de retrait valide et à la vérification du badge." },
    ],
  ...
  const en = {
    ...
    maj: "Last updated",
    sections: [
      { h: "1. Purpose", p: "These terms govern use of the Keywi service for dropping off and handing over keys through a network of partner shops." },
      { h: "2. The service", p: "Keywi connects depositors with drop-off points. The depositor remains responsible for the keys entrusted and for the access they share via pickup codes." },
      ...
      { h: "4. Liability", p: "Keywi undertakes to ensure the traceability of every movement. Keys are handed over only on presentation of a valid pickup code and verification of the tag." },
    ],
