...
function contenu(locale: Locale): {
  ...
  if (locale === "en") {
    return {
      ...
      form: {
        ...
        codeCommercial: "Sales rep code (optional)",
        codeCommercialAide: "If a KeyWe rep signed you up, enter their code (e.g. KW-MARIE).",
  ...
  return {
    ...
    form: {
      ...
      codeCommercial: "Code du commercial (facultatif)",
      codeCommercialAide: "Si un commercial KeyWe vous a démarché, entrez son code (ex. KW-MARIE).",
