...
const ENTREES: CasUsageEntree[] = [
  {
    ...
    fr: {
      ...
      temoignage: { citation: "Je gère deux studios à distance. Depuis Keywi, je n'ai plus jamais traversé Paris pour une remise de clés.", auteur: "Camille, hôte à Paris 10ᵉ" },
    },
    en: {
      menu: "Airbnb hosts",
      ...
      description:
        "Drop your keyring off at a Keywi partner shop near your rental. Each guest gets a unique pickup code and collects the keys during the shop's opening hours — and you're notified of every movement, in real time.",
      benefices: [
      ...
      temoignage: { citation: "I manage two studios remotely. Since Keywi, I've never crossed Paris for a key handover again.", auteur: "Camille, host in Paris 10th" },
    },
  },
  {
    slug: "conciergeries",
    ...
    en: {
      ...
      description:
        "Keywi replaces the key drawer and the spreadsheet. Each keyring is identified by an RFID tag scanned at every movement: you know who has what, where, and since when. Your field teams and contractors pick up keys at the nearest drop-off point, each with their own code.",
      benefices: [
  ...
  },
  {
    ...
    en: {
      ...
      description:
        "Drop the property keys at the nearest Keywi shop. Each visitor gets a code valid for the duration of their job. You track pickups and returns live, and the RFID tag guarantees the right keyring always comes back to the right slot.",
      benefices: [
  ...
  },
  {
    ...
    en: {
      ...
      description:
        "Between two tenants, the keys pass through your Keywi drop-off point: the outgoing tenant drops them off, the incoming one collects them with their code. You approve each step remotely and keep a full history of the turnover.",
      benefices: [
  ...
  },
  {
    ...
    en: {
      ...
      description:
        "For your annexe rooms or suites outside the main building, Keywi acts as a remote front desk. The guest receives their code at booking, collects their keys at the partner shop, and your team tracks everything from the back office.",
      benefices: [
  ...
  },
  {
    ...
    fr: {
      ...
      temoignage: { citation: "Ma fille de 12 ans a un code Keywi en cas d'oubli. La boulangerie est sur le chemin de l'école.", auteur: "Aïcha, maman dans le 11ᵉ" },
    },
    en: {
      ...
      description:
        "Leave a spare set of keys at your neighbourhood Keywi drop-off point. When you need it, generate a code for yourself or someone close: no more €150 locksmith when the door slams shut.",
      benefices: [
      ...
      temoignage: { citation: "My 12-year-old has a Keywi code in case she forgets hers. The bakery is on the way to school.", auteur: "Aïcha, mum in the 11th" },
    },
  },
  {
    ...
    fr: {
      ...
      temoignage: { citation: "Je fais six logements par jour. Les badges Keywi m'évitent une heure de logistique quotidienne.", auteur: "Rosa, auto-entrepreneuse ménage" },
    },
    en: {
      ...
      temoignage: { citation: "I do six homes a day. Keywi tags save me an hour of logistics every day.", auteur: "Rosa, self-employed cleaner" },
    },
  },
];
